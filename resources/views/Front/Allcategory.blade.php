...
@section('content')
    <section id="Blog">
        ...
        <div class="container">
            <h3>@lang('main.Category') : @lang('main.' . $category->name) </h3>
            <div class="vertical-space-20"></div>
            <p>@lang('main.Description') : {{ $category->description }}</p>
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="blog-box">
                        ...
                        <p class="float-left font-color-black width"><a href="#"
                                class="font-color-black font-size-14">@lang('main.Created since') :
                                {{ $category->created_at->diffForHumans() }}</a></p>
                        <div class="vertical-space-20"></div>
                        <a href="#" class="font-color-orange font-bold">#{{ count($category->jops) }}
                            @lang('main.Jops in this category')
    ...
    <section id="v2-resent-job-post">
        ...
        <div class="container text-center">
            <h3 class="text-center">@lang('main.Recent Job Post in This Catefgory')</h3>
