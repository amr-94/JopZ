...
@section('content')
    <section id="Blog">
        ...
        <div class="container">
            <h3>
                <p class="font-color-orange font-bold">Company name :</p> {{ $company->name }}
            </h3>
            <div class="vertical-space-20"></div>
            <p>
            <p class="font-color-orange font-bold">Company description :</p>{{ $company->description }}</p>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="blog-box">
                        ...
                        <p class="font-color-orange font-bold">Company email :</p>
                        <a class="font-bold font-color-black" href="mailto:{{ $company->email }}">
                            {{ $company->email }} </a>
                        </p>
                        <p class="float-left font-color-black width">
                        <p class="font-color-orange font-bold"> Company phone :
                        ...
                        <a href="#" class="font-color-orange font-bold"># <a class="font-bold font-color-black">
                                {{ count($company->jops) }}</a> jops in this
                            Company
    ...
    <section id="v2-resent-job-post">
        ...
        <div class="container text-center">
            <h3 class="text-center">Recent Job Post in This Company</h3>
